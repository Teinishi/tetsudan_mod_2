...
- ME IGBT (1): 三菱 IGBT (相鉄 10000 系未更新車)
- ME IGBT (M): 三菱 IGBT (名鉄) [マイコン](https://steamcommunity.com/sharedfiles/filedetails/?id=3648778229)
...
### ポイント通過音 (Train Point Running Sound)

前後車軸付近に Physics Sensor を配置しそれぞれの信号を入力してください。GPS 座標を Component Lua 内のデータベースと照合し、分岐器上を通過しているかどうかを判定して音声を再生します。

| 録音時の速度 | 録音した車両                 | 備考         |
| :----------- | :--------------------------- | :----------- |
| 60km/h 程度  | E235 系 1000 番台 グリーン車 | ポイント通過 |
...
- 2025/09/25 v0.1.7
    ...
    - VVVF サウンドマイコンを配布
- 2025/09/26 v0.1.8
    - ME GTO の ogg ファイルがステレオだったのをモノラルに修正
- 2025/09/26 v0.1.9
    - 小ウェッジ 2 種類を追加
    - マスコンの音のバグを修正
- 2025/10/04 v0.1.10
    - 乗務員ブザーの可聴範囲を 5m から 15m に変更
    - 分岐器通過音を変更
    - ピラーつき窓枠のミスを修正
- 2025/10/07 v0.1.11
    - ピラーつき窓のガラス部のミスを修正
- 2025/11/03 v0.1.12
    - 分岐器通過音を変更
- 2026/01/18 v0.1.13
    - ME IGBT の VVVF サウンドのラベルを ME IGBT (1) に変更
    - ME IGBT (M) の VVVF サウンドを追加
