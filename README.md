...
-   Train Running Sound
    ...
    5: 80km/h 程度、定尺レール (E231 系 0 番台 常磐線)
    6: 110km/h 程度 (E235 系 1000 番台)
    7: 50km/h 程度、スペノ削正 (E235 系 1000 番台)
    8: 90km/h 程度、スペノ削正 (E235 系 1000 番台 先頭車)
    9: 75km/h 程度、定尺レール (E235 系 1000 番台 グリーン車)
...
-   2025/08/31 v0.1.1 XML 戸袋用 Porthole、4x5 Porthole を追加
